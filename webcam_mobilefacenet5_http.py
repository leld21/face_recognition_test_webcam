...
class FaceRecognition:
    ...
    def adicionar_nome(self, nome, image):
            print(nome)
            ...
            if (nome is not None and image is not None):
                ...
                print(len(self.tupla_encodings_nome))
...
class RequestHandler(BaseHTTPRequestHandler):
    ...
    def _send_response(self, message):
        ...
        self.send_header('Access-Control-Allow-Origin', '*')  # Isso permite solicitações de qualquer origem
        self.end_headers()
    ...
    def do_POST(self):
        ...
        response_message = f"deu tudo certo"
